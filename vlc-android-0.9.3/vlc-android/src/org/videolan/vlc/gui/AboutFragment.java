...
public class AboutFragment extends SherlockFragment {
    ...
    public void onShowRemotePage(View v){
    	Log.e("Remote", "Show remote page");
    	startActivity(new Intent(getActivity(), RemoteTestActivity.class));
