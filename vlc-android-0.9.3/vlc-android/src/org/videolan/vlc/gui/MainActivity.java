...
public class MainActivity extends SherlockFragmentActivity {
    ...
    public void sendPlay(View v) {    	
    	  ...
    	  VLCCallbackTask task = new VLCCallbackTask(MainActivity.this)
          {
              @Override
              public void run() {
            	String rtspurl = "rtsp://192.168.4.108:10564";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.ml_menu_preferences:
                ...
                break;
             // remote Preferences
            case R.id.ml_menu_remote:
                intent = new Intent(this, PreferencesRemoteActivity.class);
                startActivityForResult(intent, ACTIVITY_RESULT_PREFERENCES);
                break;
    ...
    private void onOpenMRL() {
        ...
        input.setText("");
        input.append(Protocol.getRtspUrl());
            ...
            public void onClick(DialogInterface dialog, int button) {
                ...
                VLCCallbackTask task = new VLCCallbackTask(MainActivity.this)
                {
                    ...
                    public void run() {
                      ...
                      Protocol.setRtspUrl(s);  //jason  init Protocol
